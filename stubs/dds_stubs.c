...
dds_qos_t*
dds_state_qos() {
  dds_qos_t* state_qos = create_dds_state_qos();
  return state_qos;
}
...
dds_entity_t s_create_state_reader(dds_entity_t s, dds_entity_t t) {
  printf(">> s_create_state_reader\n");
  fflush(stdout);
  return dds_create_reader(s, t, dds_state_qos(), NULL);
}

dds_entity_t
s_create_event_reader(dds_entity_t s, dds_entity_t t) {
  printf("stub:>> s_create_event_reader\n");
  fflush(stdout);
...
dds_entity_t s_create_state_writer(dds_entity_t p, dds_entity_t t) {
  return dds_create_writer(p, t, dds_state_qos(), NULL);
}
...
dds_bit_SKeySValue* s_take_sksv(dds_entity_t r) {
  // dds_bit_SKeySValue* pv = malloc(sizeof(dds_bit_SKeySValue));
